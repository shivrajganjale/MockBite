<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="usersignup.aspx.cs" Inherits="projectmockbite.usersignup" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="Enter your College Name" TextMode="MultiLine" Rows="2"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                        ...
                        <div class="form-group">
                           ...
                           <asp:TextBox class="form-control" ID="TextBox8" runat="server" placeholder="Enter a Password" TextMode="Password"></asp:TextBox>
